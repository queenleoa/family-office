...
contract DemoHappyPathScript is BaseScript {
    ...
    function run() external {
        ...
        wrapper = WhalePoolWrapper(0x932E43d6367599aE19E1099e50e8dE2Ee7149a00); // Replace with deployed address
        ...
        depositForMember(poolKey, msg.sender, 1000e6); // You: 1000 PYUSD
        vm.startBroadcast();
        console.log("Family members now: 4");
        console.log("Total pooled: 4000 PYUSD");
