    ...
    <div className="app-container">
      ...
      <header className="header">
        <div className="header-content">
          <div className="logo-section">
            ...
            <span className="tagline">Every Family Deserves a Family office</span>
          </div>
          <ConnectButton />
        </div>
      </header>
      ...
      <section className="hero">
        ...
        <div className="powered-by">
          ...
          <img src="/pyusd logo.jpg" alt="PayPal" className="partner-logo" />
          <span>&</span>
          <img src="/Uniswap_Logo.svg.png" alt="Uniswap" className="partner-logo" />
        </div>
      </section>
      ...
      <div className="main-content">
        <div className="content-grid">
          ...
          <img src="/famoff_logo.png" alt="logo"  />
